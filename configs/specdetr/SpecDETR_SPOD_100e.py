...
model = dict(
    ...
    decoder=dict(
        ...
        layer_cfg=dict(
            ...
            norm_cfg=dict(type=norm)
        ),  # 0.1 for DeformDETR  norm_cfg=dict(type="LN")
        post_norm_cfg=None
    ),
    ...
    dn_cfg=dict(  # TODO: Move to model.train_cfg ?
        ...
        # group_cfg=dict(dynamic=False, num_groups=30, num_dn_queries=200),
        group_cfg=dict(dynamic=True, num_groups=None, num_dn_queries=200),
        # group_cfg=dict(dynamic=False, num_groups=10, num_dn_queries=None),
