...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='S:/HSI/SpecDETR/MUUFLGulfport/annotations/test.json',
...
log_level = 'INFO'
load_from = './work_dirs/SpecDETR/SpecDETR_MUUFLGulfport_24e.pth'
resume = False
norm = 'LN'
num_levels = 2
in_channels = 72
...
launcher = 'none'
work_dir = './work_dirs/SpecDETR/MUUFLGulfport'
